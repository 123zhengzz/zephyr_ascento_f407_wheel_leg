...
/*
 * 活跃控制器使用 MATLAB 四连杆仿真的腿长调度 LQR 增益。
 * 下方 C0~C3 多项式系数会在运行时按当前平均腿长求值。
 * K_* 宏保留为 0.115 m 站立腿长下的后备/参考值。
 *
 * MATLAB four-link LQR gain schedule used by the active controller.
 *
 * Coefficients are generated by:
 *   scripts/recompute_lqr_gains.m
 *
 * Runtime gains are evaluated as:
 *   K0 = C0_A * L^2 + C0_B * L + C0_C
 *   K1 = C1_A * L^2 + C1_B * L + C1_C
 *   K2 = C2
 *   K3 = C3_A * L^2 + C3_B * L + C3_C
 * where L is the average left/right leg length in metres.
 */

/* Zephyr-parameter LQR polynomial coefficients (C0~C3). */
#define APP_ASCENTO_GAIN_C0_A  -59.40269692f   /* K_pitch polynomial a */
#define APP_ASCENTO_GAIN_C0_B   17.93409573f   /* K_pitch polynomial b */
#define APP_ASCENTO_GAIN_C0_C   -8.962238054f  /* K_pitch polynomial c */
#define APP_ASCENTO_GAIN_C1_A  -54.51745738f   /* K_pitch_rate polynomial a */
#define APP_ASCENTO_GAIN_C1_B   18.40135485f   /* K_pitch_rate polynomial b */
#define APP_ASCENTO_GAIN_C1_C   -2.812553242f  /* K_pitch_rate polynomial c */
#define APP_ASCENTO_GAIN_C2     -3.464101615f  /* K_position constant */
#define APP_ASCENTO_GAIN_C3_A  -39.73239567f   /* K_velocity polynomial a */
#define APP_ASCENTO_GAIN_C3_B   14.45755025f   /* K_velocity polynomial b */
#define APP_ASCENTO_GAIN_C3_C   -4.034081544f  /* K_velocity polynomial c */
