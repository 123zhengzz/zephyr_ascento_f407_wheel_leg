...
#define APP_PID_BALANCE_LOCK_JOINT_TERM_RAD \
	((float)(APP_PID_BALANCE_LOCK_HEIGHT - APP_HEIGHT_MIN) * \
	 APP_LEG_RAD_PER_HEIGHT_UNIT)
#define APP_PID_BALANCE_LOCK_LEFT_JOINT_RAD \
	(APP_LEFT_LEG_ZERO_RAD + APP_PID_BALANCE_LOCK_JOINT_TERM_RAD)
#define APP_PID_BALANCE_LOCK_RIGHT_JOINT_RAD \
	(APP_RIGHT_LEG_ZERO_RAD - APP_PID_BALANCE_LOCK_JOINT_TERM_RAD)
#define APP_PID_BALANCE_USE_ROLL_AXIS 1
#define APP_PID_BALANCE_AXIS_SIGN 1.0f
#define APP_PID_BALANCE_ZERO_DEG 1.70f
...
#define APP_PID_BALANCE_ANGLE_P 350.0f
#define APP_PID_BALANCE_ANGLE_I 0.0f
#define APP_PID_BALANCE_ANGLE_D 0.0f
#define APP_PID_BALANCE_GYRO_P 6.0f
#define APP_PID_BALANCE_DISTANCE_P 0.0f
#define APP_PID_BALANCE_SPEED_P 3000.0f
